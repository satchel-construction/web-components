...
export default class Select extends HTMLElement {
  ...
  constructor() {
    ...
    this.title = this.shadowRoot.querySelector("p#title");
    ...
    this.dropdownContent = this.inputContainer.querySelector(":not(input)");
  ...
  render() {
    ...
    this.optionsContainer.append(elements);
  }
  ...
  bindEvents() {
    ...
    this.search.addEventListener("focus", () => this.unravel());
